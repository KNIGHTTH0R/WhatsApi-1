...
class Client
{
	...
	public function sendGetHasVoipEnabled($jids)
	{
		...
		$userNode = [];
		foreach ($jids as $jid) {
			$userNode[] = new ProtocolNode("user", ['jid' => $this->getJID($jid)], null, null);
		}
	...
	protected function createFeaturesNode()
	{
		...
		$parent = new ProtocolNode("stream:features", null, [$readreceipts, $groupsv2, $privacy, $presencev2], null);
